...
public class PartyRelationship extends UUIDModel {
    ...
    public enum RelationshipType {
        ORG_ROLLUP("隶属关系"), SUPPLIER("供应关系"), CUSTOMER("客户关系"), PARTNERSHIP("合作关系"), EMPLOYMENT("雇佣关系"), AGENT("代理关系"), DISTRIBUTION_CHANNEL("分销渠道关系"), EMERGENCY_CONTACT("紧急联系人关系"), FAMILY("家庭成员关系");
