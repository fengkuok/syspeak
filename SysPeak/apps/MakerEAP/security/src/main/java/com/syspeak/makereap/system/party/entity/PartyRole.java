...
public class PartyRole extends UUIDModel {
    ...
    public enum RoleType {
        INTERNAL_ORG("内部组织"), PARENT_ORG("最上级组织"), CORPORATION_GROUP("集团"), CORPORATION("公司"), SUBSIDIARY("分公司"), DIVISION("分支机构"), DEPARTMENT("部门"), TEAM("小组"), OTHER_ORG_UNIT("其它组织单元"), EMPLOYEE("职员"), EMPLOYER("雇主"), EMERGENCY_CONTACT("紧急联系人"), PARENT("父母"), COUPLE("夫妻"), BROTHERS("兄弟"), SISTERS("姐妹"), CHILD("孩子");
