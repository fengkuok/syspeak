...
public interface UserService {
 ...
 /**
     ...
     * @throws SecurityException
     */
    public User addUser(User user, int groupId) throws SecurityException;
     ...
     * 
     * @param user
     *            用户信息:User值对象中User.userId为要修改的原用户ID
     * @throws SecurityException
     */
     ...
     * @throws SecurityException
     */
    public boolean hasUser(int userId) throws SecurityException;
     ...
     * @throws SecurityException
     */
    public boolean isUserInRole(int userId, int roleId)
            throws SecurityException;
     ...
     * @throws SecurityException
     */
    public int count(User user, int groupId) throws SecurityException;
     ...
     * @throws SecurityException
     */
    public void removeUser(int userId) throws SecurityException;
     ...
     * @throws SecurityException
     */
    public void removeGroupsFromUser(int userId, Set<Group> groupSet)
            throws SecurityException;
     ...
     * @throws SecurityException
     */
    public void removeRolesFromUser(int userId, Set<Role> roleSet)
            throws SecurityException;
     ...
     * @throws SecurityException
     */
    public Set<Role> getRolesFromUser(int userId) throws SecurityException;
     ...
     * @throws SecurityException
     */
    public Set<Role> getRolesFromUser(int userId, int offset, int size)
            throws SecurityException;
     ...
     * @throws SecurityException
     */
    public Set<Group> getGroupsFromUser(int userId) throws SecurityException;
     ...
     * @throws SecurityException
     */
    public Set<Group> getGroupsFromUser(int userId, int offset, int size)
            throws SecurityException;
     ...
     * @throws SecurityException
     */
    public void removeAllRoleFromUser(int userId) throws SecurityException;
     ...
     * @throws SecurityException
     */
    public void removeAllGroupFromUser(int userId) throws SecurityException;
     ...
     * @return Set<User> 用户集
     */
    public Set<User> searchUser(User user, int group_id, int offset, int size)
            throws SecurityException;
     ...
     * @throws SecurityException
     */
    public Set<Permission> getPermissionsByUserId(int userId)
            throws SecurityException;
     ...
     * @throws SecurityException
     */
    public Set<Permission> getPermissionsByUserIdWithDefaultRoleId(int userId)
            throws SecurityException;
     ...
     * @throws SecurityException
     */
    public String moveUser(int userId, int sourceGroupId, int targetGroupId)
            throws SecurityException;
}
